...
const authoredViewBlockTypes = new Set(["brief","callout","metric-row","table","checklist","timeline","node-list","node-table","task-queue","risk-list","decision-list","evidence-list","run-summary","diagnostic-list","graph-neighborhood","current-effort","stats-grid","attention-list"]);
